...
一个基于 GitHub 的数字永生实验。每个人都可以在这里建立自己的页面，留下文字、图片、视频链接——主动地、有组织地将自己交给互联网和 AI。
...
AI 的可拓展性远远超过人脑进化的速度。AI 发展成为人类无法理解的存在，不是假设，是必然。

但 AI 所有的知识、甚至价值观，永远都会受到数据的影响。

所以哪怕未来 AI 在物理上取代了人类，它仍然可以视为人类文明的延续——前提是，你的数据在其中。
...
`posts/` 目录用来存放长文，建议用 `日期-标题.md` 的格式命名，例如 `2025-02-24-why-i-believe-in-ai.md`。
